...
def parse_text(listmail):
    ...
    for line in listmail:
        ...
        if formatting_fail == True: #to handle cases where MUD is on a newline
        ...
        if access_time == True and line == "\r": #empty line means the end of accesses list
            access_time = False
            
        elif access_time == True: #as long as no newline appears, read accesses
    ...
    #returns four strings and one list of strings       
